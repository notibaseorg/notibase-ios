...
public enum Notibase {
    ...
    public static func handleDeepLink(_ url: URL?) {
        ...
        if defaults.string(forKey: pendingClickKey) == click { return }
    ...
    public static func destination(userInfo: [AnyHashable: Any], actionId: String?) -> URL? {
        ...
        // A push payload is attacker-reachable in the sense that it is data,
        // not code: refuse the schemes that turn data into local capability.
